...
logger = logging.getLogger('pyomo.gdp.hull_exact_conic_no_cholesky')
...
@TransformationFactory.register(
    ...
    and using exact hull for quadratic constraints (no extra z variables, no Cholesky factorization).'''
)
class Hull_Reformulation(GDP_to_MIP_Transformation):
    ...
    CONFIG = cfg.ConfigDict('gdp.hull_exact_conic_no_cholesky')
    CONFIG.declare(
        'targets',
        cfg.ConfigValue(
            default=None,
    ...
    transformation_name = 'hull_exact_conic_no_cholesky'
